...
date: 2026-04-16
description: how onion messages can be used to jam the Lightning Network, and four proposed mitigations with their tradeoffs.
...
![Bounce amplification attack: the attacker crafts an onion message that loops between two victim nodes, causing them to rate-limit each other](./bounce_amplification.png)
...
References:
- [lightning/bolts#1052](https://github.com/lightning/bolts/pull/1052)
- [Unjamming Lightning: A Systematic Approach (eprint 2022/1454)](https://eprint.iacr.org/2022/1454.pdf)
- [Unjamming Lightning (Chaincode Research)](https://research.chaincode.com/2022/11/15/unjamming-lightning/)
...
Reference: [Bashiri & Khabbazian, FC 2024](https://ualberta.scholaris.ca/items/245a6a68-e1a6-481d-b219-ba8d0e640b5d)
...
Reference: [roasbeef, lightning-dev 2022-02](https://lists.linuxfoundation.org/pipermail/lightning-dev/2022-February/003498.html)
...
References:
- [t-bast, lightning-dev 2022-06](https://lists.linuxfoundation.org/pipermail/lightning-dev/2022-June/003623.html)
- [Rate-limiting onion messages (gist)](https://gist.github.com/t-bast/e37ee9249d9825e51d260335c94f0fcf)
